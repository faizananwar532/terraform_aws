...
module "s3" {
  ...
  allowed_origins = ["*"]
    # "https://frontend-${var.environment}.${var.domain_name}",
    # "https://api-${var.environment}.${var.domain_name}"
  custom_domain_names  = ["cdn-${var.environment}.${var.domain_name}"]
...
module "mediaconvert" {
  ...
  notification_endpoint = "https://api-${var.environment}.${var.domain_name}/sns/media-converter"
